...
A Python 3.10+ MCP server with **57 standalone tools** (60 with the optional
...
57 standalone tools currently (60 with the optional upstream integrations). Adding a new one:
...
4. **Document in [`docs/mcp-tools.md`](docs/mcp-tools.md)** with the tool's
   ...
   there — `tests_py/test_main.py::test_standalone_baseline_is_57_tools` pins
