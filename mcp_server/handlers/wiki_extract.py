...
schema = {
    "description": (
        ...
        "step every later phase reads from. Use this when new memories "
        "have accumulated and you want them queryable as structured "
        "claims. Pass memory_id to extract one; "
