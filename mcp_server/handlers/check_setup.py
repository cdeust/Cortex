...
schema = {
    ...
    "description": (
        ...
        "by a store-open check and an optional vector-search check that "
        "reports whether sqlite-vec is loaded (FTS-only search is a "
        "supported degraded mode; this check never blocks readiness). "
