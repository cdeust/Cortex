...
class KeywordExtractor(ActiveRetriever):
    ...
    _QUESTION_WORDS = {
        ...
        "whom", "does", "did", "is", "was", "are", "were", "can", "could",
        "will", "would", "should", "have", "has", "had", "do", "the", "a",
        "an", "i", "you", "me", "my", "your", "our", "they", "them", "us",
        "he", "she", "it", "its", "be", "been", "being", "to", "of", "in",
