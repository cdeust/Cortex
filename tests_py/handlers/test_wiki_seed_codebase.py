"""Tests for wiki_seed_codebase producer routing.

Verifies modern kind names and classifier-readable tags for imported markdown documents.
...
def test_architecture_path_routes_to_rfc() -> None:
    """Spec content maps to modern rfc kind.
...
def test_convention_path_routes_to_explanation() -> None:
    """Conventions and styles map to explanation.
...
def test_unknown_path_defaults_to_explanation() -> None:
    """Default content routes to explanation instead of bare notes.
