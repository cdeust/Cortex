"""A handler still running inside on_request receives a shutdown error on read EOF.

This covers only that interleaving; it does not assert that completed handlers always
