# ADR-0714: scripts/check_marketplace_pins.py implementation decisions

Status: accepted; preserved from the existing implementation during issue #514.

These are historical implementation records, not new algorithm or threshold choices.
Source: `scripts/check_marketplace_pins.py`; original SHA-256 `132ce52b5d15441698b1e4d93c671116f6fc8880bdd4e96e397508ff705145ff`.

## Original docstring, lines 2–97
...
## Original comment, lines 105–108
...
## Original comment, lines 152–164
