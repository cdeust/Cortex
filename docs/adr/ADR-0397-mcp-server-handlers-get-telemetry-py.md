<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0397-mcp-server-handlers-get-telemetry-py.md; ADR-0397. Read-only mirror: edit the canonical wiki page. -->
