<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0717-scripts-check-version-surfaces-py.md; ADR-0717. Read-only mirror: edit the canonical wiki page. -->
