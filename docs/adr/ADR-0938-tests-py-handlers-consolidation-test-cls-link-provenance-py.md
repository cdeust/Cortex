<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0938-tests-py-handlers-consolidation-test-cls-link-provenance-py.md; ADR-0938. Read-only mirror: edit the canonical wiki page. -->
