<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0978-tests-py-infrastructure-test-config-py.md; ADR-0978. Read-only mirror: edit the canonical wiki page. -->
