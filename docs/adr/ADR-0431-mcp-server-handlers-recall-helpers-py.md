<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0431-mcp-server-handlers-recall-helpers-py.md; ADR-0431. Read-only mirror: edit the canonical wiki page. -->
