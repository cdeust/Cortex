<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0438-mcp-server-handlers-remember-helpers-py.md; ADR-0438. Read-only mirror: edit the canonical wiki page. -->
