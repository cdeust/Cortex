<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0369-mcp-server-handlers-consolidation-memory-staleness-pass-py.md; ADR-0369. Read-only mirror: edit the canonical wiki page. -->
