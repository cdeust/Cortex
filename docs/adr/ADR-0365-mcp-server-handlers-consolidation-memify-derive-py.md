<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0365-mcp-server-handlers-consolidation-memify-derive-py.md; ADR-0365. Read-only mirror: edit the canonical wiki page. -->
