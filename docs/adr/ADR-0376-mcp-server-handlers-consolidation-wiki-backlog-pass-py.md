<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0376-mcp-server-handlers-consolidation-wiki-backlog-pass-py.md; ADR-0376. Read-only mirror: edit the canonical wiki page. -->
