<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0464-mcp-server-handlers-wiki-pipeline-py.md; ADR-0464. Read-only mirror: edit the canonical wiki page. -->
