<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0416-mcp-server-handlers-ingest-provenance-py.md; ADR-0416. Read-only mirror: edit the canonical wiki page. -->
