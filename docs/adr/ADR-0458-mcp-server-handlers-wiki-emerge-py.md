<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0458-mcp-server-handlers-wiki-emerge-py.md; ADR-0458. Read-only mirror: edit the canonical wiki page. -->
