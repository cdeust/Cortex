<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0475-mcp-server-handlers-wiki-write-py.md; ADR-0475. Read-only mirror: edit the canonical wiki page. -->
