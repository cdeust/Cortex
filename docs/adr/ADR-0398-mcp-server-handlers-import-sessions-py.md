<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0398-mcp-server-handlers-import-sessions-py.md; ADR-0398. Read-only mirror: edit the canonical wiki page. -->
