<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0428-mcp-server-handlers-rate-memory-py.md; ADR-0428. Read-only mirror: edit the canonical wiki page. -->
