<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0972-tests-py-hooks-test-hook-receipts-unit-py.md; ADR-0972. Read-only mirror: edit the canonical wiki page. -->
