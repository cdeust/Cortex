<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0361-mcp-server-handlers-consolidation-headless-authoring-py.md; ADR-0361. Read-only mirror: edit the canonical wiki page. -->
