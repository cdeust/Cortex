<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0445-mcp-server-handlers-seed-project-py.md; ADR-0445. Read-only mirror: edit the canonical wiki page. -->
