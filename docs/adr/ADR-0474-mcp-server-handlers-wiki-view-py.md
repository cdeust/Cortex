<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0474-mcp-server-handlers-wiki-view-py.md; ADR-0474. Read-only mirror: edit the canonical wiki page. -->
