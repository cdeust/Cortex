<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0417-mcp-server-handlers-injection-receipts-py.md; ADR-0417. Read-only mirror: edit the canonical wiki page. -->
