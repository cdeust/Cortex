<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0933-tests-py-core-test-wiki-layout-py.md; ADR-0933. Read-only mirror: edit the canonical wiki page. -->
