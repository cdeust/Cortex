<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0490-mcp-server-hooks-compaction-checkpoint-py.md; ADR-0490. Read-only mirror: edit the canonical wiki page. -->
