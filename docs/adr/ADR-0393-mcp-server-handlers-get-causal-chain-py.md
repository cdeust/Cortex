<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0393-mcp-server-handlers-get-causal-chain-py.md; ADR-0393. Read-only mirror: edit the canonical wiki page. -->
