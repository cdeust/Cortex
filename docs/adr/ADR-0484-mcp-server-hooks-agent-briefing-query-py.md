<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0484-mcp-server-hooks-agent-briefing-query-py.md; ADR-0484. Read-only mirror: edit the canonical wiki page. -->
