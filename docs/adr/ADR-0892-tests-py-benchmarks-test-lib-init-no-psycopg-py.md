<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0892-tests-py-benchmarks-test-lib-init-no-psycopg-py.md; ADR-0892. Read-only mirror: edit the canonical wiki page. -->
