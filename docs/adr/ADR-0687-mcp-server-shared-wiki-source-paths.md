<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0687-mcp-server-shared-wiki-source-paths.md; ADR-0687. Read-only mirror: edit the canonical wiki page. -->
