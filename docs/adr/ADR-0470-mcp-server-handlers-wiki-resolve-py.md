<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0470-mcp-server-handlers-wiki-resolve-py.md; ADR-0470. Read-only mirror: edit the canonical wiki page. -->
