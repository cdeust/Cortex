<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0769-scripts-migrate-decision-blocks-py.md; ADR-0769. Read-only mirror: edit the canonical wiki page. -->
