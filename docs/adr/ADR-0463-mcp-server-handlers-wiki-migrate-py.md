<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0463-mcp-server-handlers-wiki-migrate-py.md; ADR-0463. Read-only mirror: edit the canonical wiki page. -->
