<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0454-mcp-server-handlers-wiki-compile-py.md; ADR-0454. Read-only mirror: edit the canonical wiki page. -->
