<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0441-mcp-server-handlers-remember-response-py.md; ADR-0441. Read-only mirror: edit the canonical wiki page. -->
