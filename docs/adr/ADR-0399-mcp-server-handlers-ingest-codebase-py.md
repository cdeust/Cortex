<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0399-mcp-server-handlers-ingest-codebase-py.md; ADR-0399. Read-only mirror: edit the canonical wiki page. -->
