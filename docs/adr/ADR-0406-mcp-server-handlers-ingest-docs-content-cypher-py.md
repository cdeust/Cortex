<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0406-mcp-server-handlers-ingest-docs-content-cypher-py.md; ADR-0406. Read-only mirror: edit the canonical wiki page. -->
