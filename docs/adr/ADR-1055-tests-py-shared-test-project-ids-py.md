<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/1055-tests-py-shared-test-project-ids-py.md; ADR-1055. Read-only mirror: edit the canonical wiki page. -->
