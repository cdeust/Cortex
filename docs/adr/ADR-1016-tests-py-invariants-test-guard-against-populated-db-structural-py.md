<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/1016-tests-py-invariants-test-guard-against-populated-db-structural-py.md; ADR-1016. Read-only mirror: edit the canonical wiki page. -->
