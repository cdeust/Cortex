<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0971-tests-py-hooks-test-hook-receipts-py.md; ADR-0971. Read-only mirror: edit the canonical wiki page. -->
