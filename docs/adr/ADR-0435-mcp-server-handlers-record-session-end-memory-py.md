<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0435-mcp-server-handlers-record-session-end-memory-py.md; ADR-0435. Read-only mirror: edit the canonical wiki page. -->
