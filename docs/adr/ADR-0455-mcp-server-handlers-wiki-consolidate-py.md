<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0455-mcp-server-handlers-wiki-consolidate-py.md; ADR-0455. Read-only mirror: edit the canonical wiki page. -->
