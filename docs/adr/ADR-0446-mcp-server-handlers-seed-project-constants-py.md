<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0446-mcp-server-handlers-seed-project-constants-py.md; ADR-0446. Read-only mirror: edit the canonical wiki page. -->
