<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0497-mcp-server-hooks-session-lifecycle-py.md; ADR-0497. Read-only mirror: edit the canonical wiki page. -->
