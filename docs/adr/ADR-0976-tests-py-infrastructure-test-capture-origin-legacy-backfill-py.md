<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0976-tests-py-infrastructure-test-capture-origin-legacy-backfill-py.md; ADR-0976. Read-only mirror: edit the canonical wiki page. -->
