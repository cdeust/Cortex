<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0482-mcp-server-hooks-agent-briefing-keywords-py.md; ADR-0482. Read-only mirror: edit the canonical wiki page. -->
