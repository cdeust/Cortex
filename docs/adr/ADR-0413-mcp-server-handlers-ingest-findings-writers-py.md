<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0413-mcp-server-handlers-ingest-findings-writers-py.md; ADR-0413. Read-only mirror: edit the canonical wiki page. -->
