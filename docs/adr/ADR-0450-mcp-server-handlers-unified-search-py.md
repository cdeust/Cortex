<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0450-mcp-server-handlers-unified-search-py.md; ADR-0450. Read-only mirror: edit the canonical wiki page. -->
