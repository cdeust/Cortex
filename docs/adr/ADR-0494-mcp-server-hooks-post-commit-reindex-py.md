<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0494-mcp-server-hooks-post-commit-reindex-py.md; ADR-0494. Read-only mirror: edit the canonical wiki page. -->
