<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0488-mcp-server-hooks-capture-worker-logging-py.md; ADR-0488. Read-only mirror: edit the canonical wiki page. -->
