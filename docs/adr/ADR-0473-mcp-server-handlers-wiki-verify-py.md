<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0473-mcp-server-handlers-wiki-verify-py.md; ADR-0473. Read-only mirror: edit the canonical wiki page. -->
