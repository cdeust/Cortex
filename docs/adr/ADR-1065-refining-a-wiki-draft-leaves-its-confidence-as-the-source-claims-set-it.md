<!-- Generated by Cortex wiki_reindex from wiki/adr/cortex/1065-refining-a-wiki-draft-leaves-its-confidence-as-the-source-claims-set-it.md; ADR-1065. Read-only mirror: edit the canonical wiki page. -->
