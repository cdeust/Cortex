<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0380-mcp-server-handlers-consolidation-wiki-source-backfill-pass-py.md; ADR-0380. Read-only mirror: edit the canonical wiki page. -->
