<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0462-mcp-server-handlers-wiki-memory-sync-py.md; ADR-0462. Read-only mirror: edit the canonical wiki page. -->
