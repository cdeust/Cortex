<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0737-scripts-generate-pip-constraints-py.md; ADR-0737. Read-only mirror: edit the canonical wiki page. -->
