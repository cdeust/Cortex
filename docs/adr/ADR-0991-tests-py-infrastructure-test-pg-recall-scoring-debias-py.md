<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0991-tests-py-infrastructure-test-pg-recall-scoring-debias-py.md; ADR-0991. Read-only mirror: edit the canonical wiki page. -->
