<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0400-mcp-server-handlers-ingest-codebase-cypher-py.md; ADR-0400. Read-only mirror: edit the canonical wiki page. -->
