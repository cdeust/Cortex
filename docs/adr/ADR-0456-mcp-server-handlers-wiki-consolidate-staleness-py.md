<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0456-mcp-server-handlers-wiki-consolidate-staleness-py.md; ADR-0456. Read-only mirror: edit the canonical wiki page. -->
