<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0966-tests-py-handlers-test-wiki-write-path-governance-py.md; ADR-0966. Read-only mirror: edit the canonical wiki page. -->
