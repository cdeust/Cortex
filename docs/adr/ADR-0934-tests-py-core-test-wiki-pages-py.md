<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0934-tests-py-core-test-wiki-pages-py.md; ADR-0934. Read-only mirror: edit the canonical wiki page. -->
