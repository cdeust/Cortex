<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0489-mcp-server-hooks-capture-worker-policy-py.md; ADR-0489. Read-only mirror: edit the canonical wiki page. -->
