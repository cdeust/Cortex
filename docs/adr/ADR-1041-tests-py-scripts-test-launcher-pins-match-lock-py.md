<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/1041-tests-py-scripts-test-launcher-pins-match-lock-py.md; ADR-1041. Read-only mirror: edit the canonical wiki page. -->
