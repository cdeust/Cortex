<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0433-mcp-server-handlers-recall-skills-py.md; ADR-0433. Read-only mirror: edit the canonical wiki page. -->
