<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0698-mcp-server-tool-registry-memory.md; ADR-0698. Read-only mirror: edit the canonical wiki page. -->
