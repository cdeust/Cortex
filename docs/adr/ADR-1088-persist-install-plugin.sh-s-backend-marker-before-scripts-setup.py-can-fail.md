<!-- Generated by Cortex wiki_reindex from wiki/adr/cortex/1088-persist-install-plugin.sh-s-backend-marker-before-scripts-setup.py-can-fail.md; ADR-1088. Read-only mirror: edit the canonical wiki page. -->
