<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0929-tests-py-core-test-wiki-classifier-py.md; ADR-0929. Read-only mirror: edit the canonical wiki page. -->
