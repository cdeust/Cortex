<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0645-mcp-server-shared-code-tokenize.md; ADR-0645. Read-only mirror: edit the canonical wiki page. -->
