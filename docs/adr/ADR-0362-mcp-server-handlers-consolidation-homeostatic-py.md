<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0362-mcp-server-handlers-consolidation-homeostatic-py.md; ADR-0362. Read-only mirror: edit the canonical wiki page. -->
