<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0716-scripts-check-venv-lock-parity-py.md; ADR-0716. Read-only mirror: edit the canonical wiki page. -->
