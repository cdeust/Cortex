<!-- Generated by Cortex wiki_reindex from wiki/adr/migration/0391-mcp-server-handlers-explore-features-py.md; ADR-0391. Read-only mirror: edit the canonical wiki page. -->
