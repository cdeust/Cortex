...
\begin{enumerate}
  ...
  \item Empirical results on three long-term-memory benchmarks
        ...
        ($+20.0$\,pp over paper-best), R@10\,$=$\,94.35\% on LoCoMo,
...
residual collapse; \emph{ai-architect-mcp-codebase} \citep{Deust2026b} is
...
\paragraph{ai-architect-mcp-codebase---the code-structural anchor.}
Cortex memories are not anonymous text snippets; downstream
consumers expect them to refer to specific functions, types, and
call paths.  ai-architect-mcp-codebase \citep{Deust2026b} is a Rust MCP
...
The 98.4\% / 94.35\% / 0.591 numbers are corroborations of the
