...
benchmarks, Cortex reaches LongMemEval R@10\,$=$\,98.4\%
(vs.\ 78.4\% paper-best), LoCoMo R@10\,$=$\,94.2\%, and BEAM
...
The $+20.0$\,pp absolute gain on LongMemEval R@10 and the $+79.6\%$
...
\subsubsection{The plasticity-fix re-run on post-\texttt{5f737fe} bytes}
